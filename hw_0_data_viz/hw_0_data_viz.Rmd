...
###  Visual Cues
Position:
I decided to map Birth Year on to x-values because explanatory variables are usually in the x-axis by convention. Similarly, I decided to map Median Voter Participation on to y-values because dependent variables are usually in the y-axis by convention.
